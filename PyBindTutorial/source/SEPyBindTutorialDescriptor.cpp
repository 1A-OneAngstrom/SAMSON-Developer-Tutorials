/// \headerfile SEPyBindTutorialAppDescriptor.hpp "SEPyBindTutorialAppDescriptor.hpp"
#include "SEPyBindTutorialAppDescriptor.hpp"
...
SB_ELEMENT_DESCRIPTION("This tutorial demonstrates how to create python bindings for a SAMSON Extension");
SB_ELEMENT_DOCUMENTATION("Resource/Documentation/doc.html");
SB_ELEMENT_VERSION_NUMBER("2.0.0");

SB_ELEMENT_CLASSES_BEGIN;

	SB_ELEMENT_CLASS(SEPyBindTutorialApp);
