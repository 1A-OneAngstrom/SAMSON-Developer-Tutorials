...
public:
	...
	SBDTypeSpatialDomainWrapper(const SBDTypeSpatialTransform& transform, const SBDTypePhysicalVector3Wrapper<SBDQuantityWrapperSI>& halfSize) {
	...
	/// \brief Returns the arbitraty SBSpatialDomain
